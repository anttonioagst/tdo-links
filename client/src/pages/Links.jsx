...
import { AppleMonoIcon }   from "../icons/apple-mono.tsx";
import { LogitechGIcon }   from "../icons/logitech-g.tsx";
import { SamsungMonoIcon } from "../icons/samsung-mono.tsx";
import { SonyMonoIcon }    from "../icons/sony-mono.tsx";
import { HyperxMonoIcon }  from "../icons/hyperx-mono.tsx";
import { RazerMonoIcon }   from "../icons/razer-mono.tsx";
...
// Logos via @thesvg/cli — fonte oficial de ícones do projeto
const BRAND_LOGOS = {
  apple:    <AppleMonoIcon   fill="currentColor" width={28}  height={28} />,
  logitech: <LogitechGIcon   fill="currentColor" width={120} height={22} viewBox="-29 -4 165 34" />,
  samsung:  <SamsungMonoIcon fill="currentColor" width={110} height={18} viewBox="0 9.8 24 4.6" />,
  sony:     <SonyMonoIcon    fill="currentColor" width={90}  height={28} viewBox="-1 7.5 26 10" />,
  hyperx:   <HyperxMonoIcon  fill="currentColor" width={80}  height={28} viewBox="0 4.5 24 14" />,
  razer:    <RazerMonoIcon   fill="currentColor" width={34}  height={34} />,
};
