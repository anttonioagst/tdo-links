...
const BRAND_LOGOS = {
  ...
  // Logitech G — ícone G geométrico/angular (evenodd: outer L-shape minus três hollow)
  logitech: (
    <svg viewBox="0 0 24 24" fill="currentColor" width="38" height="38" aria-hidden="true">
      <path fillRule="evenodd" d="M3 3L18 3L18 12L21 12L21 21L3 21Z M6 6L6 12L18 12L18 6Z M6 12L6 15L12 15L12 12Z M6 15L6 18L18 18L18 15Z" />
    </svg>
  ),
  ...
  // Sony — viewBox com 2u de padding vertical em cada lado
  sony: (
    <svg viewBox="-1 7.5 26 10" fill="currentColor" width="96" height="28" aria-hidden="true">
